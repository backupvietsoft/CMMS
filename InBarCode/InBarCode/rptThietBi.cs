...
namespace InBarCode
{
    public partial class rptThietBi : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptThietBi(DataTable tb,int iLoai)
        {
            InitializeComponent();
            this.DataSource = tb;
            if (iLoai == 0)
            {
                ...
                lblMa.DataBindings.Add("Text", this.DataSource, "MS_MAY");
            }
            else
            {
                xrBarCode1.DataBindings.Add("Text", this.DataSource, "MS_TS");
                lblMa.DataBindings.Add("Text", this.DataSource, "MS_TS");
            }
            lblTen.DataBindings.Add("Text", this.DataSource, "TEN_MAY");
