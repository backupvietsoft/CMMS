    ...
    public partial class frmCustomer_View : Form
    {
        ...
        private void btnGhi_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show(Program.GetNN(dtNN, "msgChuaNhapTenCTY", this.Name));
                ...
                {
                    MessageBox.Show(Program.GetNN(dtNN, "msgShortName", this.Name));
                    txtShortName.Focus();
                    return;
                }
                ...
                {
                    MessageBox.Show(Program.GetNN(dtNN, "msgChuaNhapAddress", this.Name));
                    txtAddress.Focus();
                    return;
                }
                if (string.IsNullOrEmpty(txtEmail.Text.Trim()))
                {
                    MessageBox.Show(Program.GetNN(dtNN, "msgChuaNhapEmail", this.Name));
                    txtEmail.Focus();
                    return;
                }
                if (string.IsNullOrEmpty(txtPhone.Text.Trim()))
                {
                    MessageBox.Show(Program.GetNN(dtNN, "msgChuaNhapPhone", this.Name));
                    txtPhone.Focus();
                    return;
                }
                //INSERT CUSTOMER
