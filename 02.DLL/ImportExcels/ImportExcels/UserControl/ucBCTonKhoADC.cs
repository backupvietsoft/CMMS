...
{
    public partial class ucBCTonKhoADC : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBCTonKhoADC()
        {
            InitializeComponent();
        }

        private void ucBCTonKhoADC_Load(object sender, EventArgs e)
        {
        ...
        private void btnExcute_Click(object sender, EventArgs e)
        {
            ...
            frm._TableSource.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString,
                            "BCTonKhoTheoViTriKMADC", cmbKho.EditValue.ToString(),
