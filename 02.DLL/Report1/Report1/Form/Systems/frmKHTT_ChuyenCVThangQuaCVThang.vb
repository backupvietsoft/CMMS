...
Public Class frmKHTT_ChuyenCVThangQuaCVThang
    ...
    Private Sub btnLayDL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLayDL.Click
        ...
        Try
            ...
            commandGetBTDK.CommandText = "SP_GET_DATA_KHBT_CVTHANG_TO_CVTHANG"
        ...
        Try
            For i As Integer = 0 To dataSelectTMP.ToTable().Rows.Count - 1
                ...
                If dsHangMuc.Tables(0).Rows.Count = 0 Then 'chua da ton tai
                    ...
                    "VALUES ('" & dataSelectTMP.ToTable().Rows(i)("MA_HANG_MUC").ToString() & "','" & KHNam & "','" & KHThang & "','" & dsID.Tables(0).Rows(0)("ID") & "','2' ,'" & Format(dataSelectTMP.ToTable().Rows(i)("TU_NGAY"), "MM/dd/yyyy") & "','" & Format(dataSelectTMP.ToTable().Rows(i)("DEN_NGAY"), "MM/dd/yyyy") & "'" & _
                ...
                commandCV.CommandText = "INSERT INTO dbo.KE_HOACH_TONG_CONG_VIEC_CHI_TIET (MS_MAY, MA_HANG_MUC, MA_CV, MA_BO_PHAN, KH_NAM, KH_THANG,ID_TRUOC, KH_TYPE, TU_NGAY , DEN_NGAY , MS_UU_TIEN, CP_VT_NN_NGOAI_DM, CP_VT_NGOAI_DM, CP_THUE_NGOAI, TG_KH)" & _
                ...
                " FROM dbo.KE_HOACH_TONG_CONG_VIEC_CHI_TIET WHERE MA_HANG_MUC = '" & dataSelectTMP.ToTable().Rows(i)("MA_HANG_MUC").ToString() & "' AND KH_TYPE = '2' AND  KH_NAM = '" & cbNam.SelectedValue & "' AND KH_THANG = '" & cbThang.SelectedValue & "' " & _
                ...
                " DON_GIA_CUOI, NGAY_LAY_DG_KH " & _
                " FROM dbo.KE_HOACH_TONG_CONG_VIEC_PHU_TUNG_CHI_TIET WHERE HANG_MUC_ID = '" & dataSelectTMP.ToTable().Rows(i)("MA_HANG_MUC").ToString() & "' AND KH_TYPE = '2' AND  KH_NAM = '" & cbNam.SelectedValue & "' AND KH_THANG = '" & cbThang.SelectedValue & "' " & _
