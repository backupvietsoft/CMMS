...
Public Class frmKHTT_LayTuKHBTNam

    Public KHNam As String = 2014
    Public KHThang As String = "02"
    Private KHType = "2"
    ...
    Private Sub btnLayDL_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLayDL.Click
        ...
        Try
            ...
            commandGetBTDK.CommandText = "SP_GET_DATA_KHBT_NAM_TO_THANG"
            ...
            commandGetBTDK.Parameters("@KH_THANG").Value = KHThang

            commandGetBTDK.Parameters.Add("@KH_THANG_LOC", SqlDbType.Int)
            commandGetBTDK.Parameters("@KH_THANG_LOC").Value = cbThang.SelectedValue
    ...
    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        ...
        Try
            ...
            For i As Integer = 0 To dataSelectTMP.ToTable().Rows.Count - 1
                ...
                " FROM dbo.KE_HOACH_TONG_CONG_VIEC_CHI_TIET WHERE MA_HANG_MUC = '" & dataSelectTMP.ToTable().Rows(i)("HANG_MUC_ID").ToString() & "' AND KH_TYPE = '1' AND  KH_NAM = '" & KHNam & "'"
    ...
    Private Sub frmKHTT_LayTuKHBTNam_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadNamData()
        LoadThangData()
