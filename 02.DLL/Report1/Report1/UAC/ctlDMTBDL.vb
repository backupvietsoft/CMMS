...
Public Class ctlDMTBDL
    ...
    Private Sub ctlDMTBDL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            lblLoaiThietBi.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ctlDMTBDL", "lblLoaiThietBi", Commons.Modules.TypeLanguage)
            btnSelect.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ctlDMTBDL", "btnSelect", Commons.Modules.TypeLanguage)
            btnUnSelect.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ctlDMTBDL", "btnUnSelect", Commons.Modules.TypeLanguage)
            btnThucHien.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ctlDMTBDL", "btnThucHien", Commons.Modules.TypeLanguage)
