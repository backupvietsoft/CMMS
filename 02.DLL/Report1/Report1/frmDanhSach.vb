...
Public Class frmDanhSach
    ...
    '    'if (e.Column == gridView1.Columns["TEN_MAY"])
    '    '    {
    '    '        string value1 = Convert.ToString(gridView1.GetRowCellValue(e.RowHandle1, e.Column));
    '    '        string value2 = Convert.ToString(gridView1.GetRowCellValue(e.RowHandle2, e.Column));
    '    '        if (value1 == value2)
    '    '        {
    '    '            e.Merge = true;
