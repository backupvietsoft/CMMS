    ...
    public partial class ucBCTHThoiGianNgungMay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void LoadMay()
        {
            try
            {
                ...
                try
                { TNgay = Convert.ToDateTime("01/" + datTNgay.DateTime.Month + "/" + datTNgay.DateTime.Year); }
                catch { TNgay = DateTime.Parse("01/01/2000"); }

                try
                { DNgay = Convert.ToDateTime("01/" + datDNgay.DateTime.Month + "/" + datDNgay.DateTime.Year).AddMonths(1).AddDays(-1); }
       ...
       private void btnExecute_Click(object sender, EventArgs e)
       {
           try
           {
               ...
               sql = " SELECT DISTINCT TGNM.MS_MAY, A.TEN_MAY, TGNM.NGAY, CONVERT(NVARCHAR(10), TGNM.TU_GIO, 108) AS TU_GIO, " +
                           ...
                           " 		TGNM.THOI_GIAN_SUA_CHUA, B.HIEN_TUONG, D.TEN_NGUYEN_NHAN AS NGUYEN_NHAN, B.NGUYEN_NHAN_CU_THE, B.NGUOI_GIAI_QUYET, B.MS_PHIEU_BAO_TRI, TGNM.GHI_CHU,  " +
               ...
               frm._DDiem = lblDiaDiem.Text + " : " + cboDDiem.TextValue;
