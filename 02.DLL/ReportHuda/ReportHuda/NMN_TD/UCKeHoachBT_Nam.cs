...
{//public partial class UCKeHoachBT_Nam : DevExpress.XtraEditors.XtraUserControl
    public partial class UCKeHoachBT_Nam : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void LoadLoaiCV()
        {
            ...
            _table_CV.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text, 
                "SELECT MS_LOAI_CV,TEN_LOAI_CV FROM LOAI_CONG_VIEC UNION SELECT -1,' < ALL > ' ORDER BY MS_LOAI_CV"));
            try
            {
        ...
        private void btnExcute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dTNgay = Ngay;
                dDNgay = Ngay.AddYears(1).AddDays(-1);
                ...
                obj._Table_Source.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "SP_NHU_Y_GET_KE_HOACH_BAO_TRI_NAM_TD",
                                                      dTNgay , dDNgay, cmbFactory.EditValue, Commons.Modules.UserName, 
                                                      cmbKindOfWork.EditValue, Commons.Modules.TypeLanguage, 
                                                      optLoaiBC.SelectedIndex,cboDChuyen.EditValue,cboLMay.EditValue));
            ...
            {
                this.Cursor = Cursors.Default;
                MessageBox.Show(EX.Message, "Vietsoft", MessageBoxButtons.OK, MessageBoxIcon.Information);                
                return;
            }
        }
        ...
        private void cboFactory_EditValueChanged(object sender, MVControl.ucComboboxTreeList.EventArgs e)
        {
