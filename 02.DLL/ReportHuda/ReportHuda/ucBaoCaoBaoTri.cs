...
{
    public partial class ucBaoCaoBaoTri : DevExpress.XtraEditors.XtraUserControl
    {
        string sBaoTriChung = "";
        string sBC = "ucBaoCaoBaoTri";

        public ucBaoCaoBaoTri()
        {
            InitializeComponent();
        }
        #region Load Du Lieu
        ...
        private void LoadMay()
        {
            ...
            try
            {
                ...
                dtMay.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "spGetMayNXuongHThongLMay", Commons.Modules.UserName, NXuong, HThong, -1, LMay, "-1", "-1",DNgay, Commons.Modules.TypeLanguage));
        ...
        private void ucKeHoachCongViecBaoTri_Load(object sender, EventArgs e)
        {
            ...
            DateTime Ngay;
            Ngay = Convert.ToDateTime("01/" + DateTime.Now.AddMonths(-1).Month + "/" + DateTime.Now.Year);
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dtTmp = new DataTable();
                dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "spBaoCaoBaoTri", sBTam, cboLBTri.EditValue,
                    sBaoTriChung, datTNgay.DateTime.Date, datDNgay.DateTime.Date, Commons.Modules.TypeLanguage,
                    cboDonVi.EditValue, cboPhongBan.EditValue, optBCao.SelectedIndex, optBCao.Properties.Items[1].Description, 
                    optBCao.Properties.Items[2].Description, optBCao.Properties.Items[3].Description, Commons.Modules.UserName));
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                prbIN.Properties.Maximum = 39; //+ dtTmp.Rows.Count;
              ...
              if (Commons.Modules.bDoiFontReport) xlApp.Cells.Font.Name = Commons.Modules.sFontReport;
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 1, "@", 11, true,
                    Excel.XlHAlign.xlHAlignCenter, Excel.XlVAlign.xlVAlignCenter, true, Dong, TCot);
                Dong++;
                stmp = "'----o0o----";
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 1, "@", 11, true,
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 2, "@", 11, true, true, Dong, 4);
                #region prb
                prbIN.PerformStep();
                prbIN.Update();
                #endregion
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,sBC, "bcThongTinThucHien", Commons.Modules.TypeLanguage);
                title.Value2 = stmp;
                title.Font.Bold = true;
                title.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                title.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 40, "@", true, Dong + 1, 7, TDong + Dong, 7);
                ...
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 40, "@", true, Dong + 1, 16, TDong + Dong, 16);
                ...
                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong, 4, TDong + Dong , 5);
                title.Merge(true);
                title.ColumnWidth = 10;

                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong-1, 4, Dong , 5);
                title.Merge();


                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong, 6, TDong + Dong, 7);
                title.Merge(true);
                title.ColumnWidth = 20;

                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong-1, 6, Dong , 7);
                title.Merge();
                ...
                int iCotSum = 8;
                    Commons.Modules.MExcel.MFuntion(xlWorkSheet, "SUM", Dong, iCotSum, Dong, iCotSum, Dong - TDong,
                        iCotSum, Dong - 1, iCotSum, 11, true, 12, sDinhDang, Excel.XlHAlign.xlHAlignRight, Excel.XlVAlign.xlVAlignCenter);
                ...
                {
                    Dong = Dong + 4;
                    Commons.Modules.MExcel.DinhDang(xlWorkSheet, Commons.Modules.sTenNhanVienMD, Dong, 6, "@", 11, true,
                        Excel.XlHAlign.xlHAlignCenter, Excel.XlVAlign.xlVAlignCenter, true, Dong, TCot);
                }
                catch { }
                #endregion
                ...
                title = Commons.Modules.MExcel.GetRange(xlWSheet2, 12, 6, 14, 8);
                ...
                title = Commons.Modules.MExcel.GetRange(xlWSheet2, iDongTH - 1, 6, iDongTH, 7);
                ...
                #region Dinh dang
                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, 13, 1, Dong, 23);
                title.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong-5, 1, Dong-5, 1);
                title.RowHeight = 9;
                ...
                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, 13, 1, 14, 23);
                title.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                title.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;

                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, 1, 23, 1, 29);
                title.EntireColumn.Hidden = true;
        ...
        private void lblIconElearning_OpenLink(object sender, DevExpress.XtraEditors.Controls.OpenLinkEventArgs e)
        {
            //HyperLinkEdit editor = sender as HyperLinkEdit;
            //editor.OpenLink("https://www.devexpress.com/ClientCenter/Order/?group=.NET");
            System.Diagnostics.Process.Start("http://www.c-sharpcorner.com");
            //"Visit this website <a href=\"http://www.sears.com/fitness-sports-treadmills/c-1020252\">here</a>";
