...
namespace ReportHuda
{
    public partial class ucKeHoachCongViecBaoTri : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            sBaoTriChung = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "BaoTriChung", Commons.Modules.TypeLanguage);
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (optBCao.SelectedIndex != 3)
                {
                    ...
                    {
                        MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name, "msgChuaChonMay", Commons.Modules.TypeLanguage));
                        return;
                    }
                }
                else
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    this.Name, "bcTieuDeKeHoachCongViecBaoTri", Commons.Modules.TypeLanguage), Dong, 1, "@", 16, true,
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    this.Name, "bcTongCong", Commons.Modules.TypeLanguage);
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 1, "@", 10, true,
                ...
                Dong++;
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    this.Name, "bcSoCongThucHien", Commons.Modules.TypeLanguage);
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 1, "@", 10, true,
                    Excel.XlHAlign.xlHAlignRight, Excel.XlVAlign.xlVAlignCenter, true, Dong, 6);
                try
                {
                ...
                Dong++;
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, this.Name,
