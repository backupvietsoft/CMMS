...
namespace ReportHuda
{
    public partial class ucBaoCaoCongViecBaoTri : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void LoadNX()
        {
            try
            {
                Commons.Modules.ObjSystems.MLoadLookUpEdit(cboDDiem, Commons.Modules.ObjSystems.MLoadDataNhaXuong(0, "-1", "-1", "-1"), "MS_N_XUONG", "TEN_N_XUONG", lblDDiem.Text);
            }
            catch { }
        }
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dtTmp = new DataTable();
                dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "spBaoCaoCongViecBaoTri", sBTam, cboLBTri.EditValue,
                    sBaoTriChung, datTNgay.DateTime.Date, datDNgay.DateTime.Date, Commons.Modules.TypeLanguage,
                    cboDonVi.EditValue, cboPhongBan.EditValue, optBCao.SelectedIndex, optBCao.Properties.Items[1].Description, optBCao.Properties.Items[2].Description, optBCao.Properties.Items[3].Description));
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                prbIN.Update();
                #endregion
                //Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 12, "###,##%", true, Dong + 1, 8, TDong + Dong, 9);
                ...
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 12, "###,##%", true, Dong + 1, 21, TDong + Dong, 21);
