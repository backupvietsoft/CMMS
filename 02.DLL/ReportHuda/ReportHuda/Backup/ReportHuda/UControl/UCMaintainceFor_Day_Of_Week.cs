...
{
    public partial class UCMaintainceFor_Day_Of_Week : DevExpress.XtraEditors.XtraUserControl
    {
        DataTable _table;
        ...
        bool isFirst = false;
        public UCMaintainceFor_Day_Of_Week()
        {
            InitializeComponent();
        }
        ...
        private void LoadMachine()
        {
            ...
            foreach (DataColumn col in _tableMachine.Columns)
            {
                ...
                {
                    case "CHON":
                        col.Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "CHON", Commons.Modules.TypeLanguage);
                        break;
                    case "MS_MAY":
                        col.Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "MS_MAY", Commons.Modules.TypeLanguage);
                        break;
                    case "TEN_MAY":
                        col.Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "TEN_MAY", Commons.Modules.TypeLanguage);
                        break;
                }
                col.ReadOnly = true;
            ...
            foreach (DataColumn col in _tableMaintaince.Columns)
            {
                ...
                switch(caption)
                {
                    case "CHON":
                        ...
                        break;
                    case "MS_LOAI_BT":
                        col.Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "MS_LOAI_BT", Commons.Modules.TypeLanguage);
                        break;
                    case "TEN_LOAI_BT":
                        col.Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "TEN_LOAI_BT", Commons.Modules.TypeLanguage);
                        break;
                }
                col.ReadOnly = true;
            }
        ...
        {
            btnExecute.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnExecute", Commons.Modules.TypeLanguage);
            btnThoat.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnThoat", Commons.Modules.TypeLanguage);
            btnMachineChooseAll.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnMachineChooseAll", Commons.Modules.TypeLanguage);
            btnMachineUnChooseAll.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnMachineUnChooseAll", Commons.Modules.TypeLanguage);
            btnMaintaiceChooseAll.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnMaintaiceChooseAll", Commons.Modules.TypeLanguage);
            btnMaitainceUnChooseAll.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "btnMaitainceUnChooseAll", Commons.Modules.TypeLanguage);
        }
        ...
        private DataTable TableMaintaince
        {
            get
            {
                ...
                if (filterMachine.Length <= 0 || filterMaintaince.Length<=0)
                {
                    ...
                    MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "banphaichonmayloaibt",Commons.Modules.TypeLanguage),"Vietsoft" , MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return null;
                }
                DataTable _tableValue = new DataTable();
                _tableValue.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "[SP_NHU_Y_GET_KE_HOACH_BAO_TRI_TB_NGAY_TRONG_TUAN]", dateFromDate.DateTime.ToString("MM/dd/yyyy"), dateToDate.DateTime.ToString("MM/dd/yyyy"), cmbFactory.EditValue, Commons.Modules.UserName, Commons.Modules.UserName, Commons.Modules.TypeLanguage));
                ...
                if (_tableValue.Rows.Count > 0)
                {
                    ...
                    _tableValue = _tableValue.DefaultView.ToTable("DSBT_TUAN", true, "MO_TA_CV", "MAY", "BP",
                                                               "T2", "T3", "T4", "T5", "T6", "T7", "CN", "THUCHIEN", "ISCHECK");
                }
                    return _tableValue;
            }
        }
        private void btnExecute_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    frmMaintainceFor_Day_Of_Week frm = new frmMaintainceFor_Day_Of_Week();

                    frm.TableSource = TableMaintaince;

                    frm.DKLoc = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "thoigianthuchien:", Commons.Modules.TypeLanguage);
                    frm.DKLoc += " " + lblFromDate.Text + ":" + dateFromDate.Text + lblToDate.Text + ":" + dateToDate.Text;
                    frm.SubTitle = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "dinhky:hangtuan", Commons.Modules.TypeLanguage);
                    frm.SubTitle += " " + lblWeek.Text + " " + cmbWeek.Text + "/" + Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "year", Commons.Modules.TypeLanguage) + DateTime.Now.Year;
                    try
                    {
                ...
                {
                    MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "UCMaintainceFor_Day_Of_Week", "khongcodulieu", Commons.Modules.TypeLanguage), "Vietsoft", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch { }
        }
