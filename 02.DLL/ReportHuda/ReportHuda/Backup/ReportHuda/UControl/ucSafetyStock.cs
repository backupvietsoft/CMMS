        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = DongBD; i <= TDong + Dong + 2; i++)
                {
                    ...
                    Commons.Modules.MExcel.MFuntion(excelWorkSheet, "STDEVP", i, TCot - 8 + 2, i, TCot - 8 + 2, i, 7, i, TCot - 8, 0, false, 10, "###,##0.00");
                    ...
                    title.Value2 = "=" + Commons.Modules.MExcel.TimDiemExcel(i, TCot - 8 + 2)  + "*" +
                        ...
                        Commons.Modules.MExcel.TimDiemExcel(i, TCot - 8 + 5) + "))";
