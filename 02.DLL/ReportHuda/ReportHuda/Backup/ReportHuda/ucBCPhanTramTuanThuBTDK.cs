...
{
    public partial class ucBCPhanTramTuanThuBTDK : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBCPhanTramTuanThuBTDK()
        {
            InitializeComponent();
        }
        string sBC = "ucBCPhanTramTuanThuBTDK";
        ...
        private void ucBCPhanTramTuanThuBTDK_Load(object sender, EventArgs e)
        {
            DateTime Ngay;
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "spBCPhanTramTuanThuBTDK", TThang, DThang, Commons.Modules.UserName,Commons.Modules.TypeLanguage,
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, sBC, "sTieuDePhanTramTuanThuBTDK", Commons.Modules.TypeLanguage)
                ...
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 30, "@", true, Dong + 1, 2, TDong + Dong, 2);
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 10, "0.00%", true, Dong + 1, 3, TDong + Dong, TCot);
