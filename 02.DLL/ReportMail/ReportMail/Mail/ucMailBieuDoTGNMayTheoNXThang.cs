...
{
    public partial class ucMailBieuDoTGNMayTheoNXThang : DevExpress.XtraEditors.XtraUserControl
    {
        csSchedules clsSchedules = new csSchedules();
        private string TenMBaoCao = "ucMailBieuDoTGNMayTheoNXThang";
        private string DK_BAOCAO;
        private Boolean KLoad;
        public ucMailBieuDoTGNMayTheoNXThang()
        {
            InitializeComponent();
        }
        ...
        private void ucMailBieuDoTGNMayTheoNXThang_Load(object sender, EventArgs e)
        {
            KLoad = false;
