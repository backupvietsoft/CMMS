...
{
    public partial class ucPBTTrongNgay : DevExpress.XtraEditors.XtraUserControl
    {
        csSchedules clsSchedules = new csSchedules();
        private string TenMBaoCao = "ucPBTTrongNgay";
        private string DK_BAOCAO;

        public ucPBTTrongNgay()
        {
            InitializeComponent();
        }
        ...
        private void ucPBTTrongNgay_Load(object sender, EventArgs e)
        {
            LoadCbo();
