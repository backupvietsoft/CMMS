...
{
    public partial class ucMailBieuDoChiPhiTheoNXThang : DevExpress.XtraEditors.XtraUserControl
    {
        csSchedules clsSchedules = new csSchedules();
        private string TenMBaoCao = "ucMailBieuDoChiPhiTheoNXThang";
        private string DK_BAOCAO;
        private Boolean KLoad;

        public ucMailBieuDoChiPhiTheoNXThang()
        {
            InitializeComponent();
                        ...
                        foreach (string s in chuoi_tach)
                        {
                            ...
                            if (i == 9)
                            {
                                ...
                                Commons.Modules.ObjSystems.MCreateTableToDatatable(Commons.IConnections.ConnectionString,
                                    "AAA_MAIL_CPTNX_TMP" + Commons.Modules.UserName, dtTmp, "");
                                SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, CommandType.Text,
                                    "UPDATE AAA_MAIL_CPTNX_TMP" + Commons.Modules.UserName + " SET CHON = 0 " +
                                ...
                                dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text,
                                    "SELECT * FROM AAA_MAIL_CPTNX_TMP" + Commons.Modules.UserName + " ORDER BY " + sStm1));
                                ...
                                Commons.Modules.ObjSystems.XoaTable("AAA_MAIL_CPTNX_TMP" + Commons.Modules.UserName);
        ...
        private void TaoCbo()
        {
            ...
            Commons.Modules.ObjSystems.MLoadLookUpEdit(cboNXuong, sSql, "MS", "TEN_N_XUONG", "");
        ...
        private void ucMailBieuDoChiPhiTheoNXThang_Load(object sender, EventArgs e)
        {
            KLoad = false;
            TaoCbo();
