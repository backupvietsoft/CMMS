...
{
    public partial class ucPBTQuaHanKT : DevExpress.XtraEditors.XtraUserControl
    {
        csSchedules clsSchedules = new csSchedules();
        private string TenMBaoCao = "ucPBTQuaHanKT";
        private string DK_BAOCAO;

        public ucPBTQuaHanKT()
        {
            InitializeComponent();
        }
        ...
        private void ucPBTQuaHanKT_Load(object sender, EventArgs e)
        {
            LoadCbo();
