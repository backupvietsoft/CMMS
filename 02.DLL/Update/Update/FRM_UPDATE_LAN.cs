...
namespace Update
{
    public partial class FRM_UPDATE_LAN : Form
    {
        Boolean status = false;
        BackgroundWorker bw = new BackgroundWorker();
        BackgroundWorker bw2 = new BackgroundWorker();
        public FRM_UPDATE_LAN()
        {
            InitializeComponent();
        ...
        {
            //if (txtUrlUpdate.Text == "")
            //    MessageBox.Show("Please Enter URL To Download File.");
            //else
            //{
            //    listBox1.Items.Add("Download File Version");
            //    listBox1.Items.Add("Check Version");
            //    listBox1.Items.Add("Download File Update");
            //    lbPT.Text = "0 %";
        ...
        {
            string sUrlToDnldFile = Program.URL_LAN + @"\Update.zip";
...

            {
                ...
                bgWorker1.ReportProgress(50);
                if (File.Exists(sFileSavePath))
                {
                    File.Delete(sFileSavePath);
                }
                bgWorker1.ReportProgress(98);
                File.Copy(sUrlToDnldFile, sFileSavePath);
        ...
        {
            string sUrlToDnldFile = Program.URL_LAN + @"\Version.txt"; ;
        ...
        private void FRM_UPDATE_Load(object sender, EventArgs e)
        {
            ...
            txtUrlUpdate.Text = Program.URL_LAN;
