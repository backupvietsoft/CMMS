            ...
            Try
                ...
                For i As Integer = 0 To dtTable.Rows.Count - 1
                    ...
                    If Not IsDBNull(row("SL_TON_TT")) And row("SL_TON_TT").ToString <> "" Then
                        Commons.Modules.SQLString = "INSERT INTO KIEM_KE_VAT_TU_CHI_TIET(NGAY,MS_KHO,MS_PT,STT,MS_VI_TRI,MS_DH_NHAP_PT,SL_KK_CT,SL_CHUNG_TU,GHI_CHU, ID_KK) " &
                               "VALUES(N'" & Format(CDate(NGAY), "dd/MMM/yyyy") & "'," & MS_KHO & ",'" & row("MS_PT").ToString & "'," & i + 1 & "," &
                        ...
                        SQLString_VI_TRI_KHO = "UPDATE VI_TRI_KHO_VAT_TU SET SL_VT = " & row("SL_TON_TT").ToString &
                                            " WHERE MS_KHO = " & MS_KHO & " AND MS_PT = '" & row("MS_PT").ToString & "' AND MS_VI_TRI = '" & Integer.Parse(row("MS_VI_TRI").ToString) &
