...
Namespace VS.Classes.Catalogue
    ...
    Public Class clsHIEU_CHUAN_MAYController
        ...
        Public Function GetMS_MAY_HIEU_CHUAN_MAY() As DataTable
            ...
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetMS_MAY_HIEU_CHUAN_MAY", Modules.UserName))
            Return objDataTable
        End Function
        Public Function GetHIEU_CHUAN_MAY_Theo_NGAY_HC(ByVal strTU_NGAY As Date, ByVal strDEN_NGAY As Date) As DataTable
            Dim objDataTable As DataTable = New DataTable
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetHIEU_CHUAN_MAY_Theo_NGAY_HC", strTU_NGAY, strDEN_NGAY, Modules.UserName))
            Return objDataTable
        End Function
        Public Function GetHIEU_CHUAN_MAY_Theo_MS_MAY(ByVal strMS_MAY As String) As DataTable
            Dim objDataTable As DataTable = New DataTable
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetHIEU_CHUAN_MAY_Theo_MS_MAY", strMS_MAY, Modules.UserName))
            Return objDataTable
        End Function

        Public Function GetHIEU_CHUAN_MAYs() As DataTable
            Dim objDataTable As DataTable = New DataTable
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetHIEU_CHUAN_MAYs_Moi", Modules.UserName))
            Return objDataTable
        End Function
