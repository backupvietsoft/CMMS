...
Namespace VS.Classes.Catalogue
    ...
    Public Class clsHIEU_CHUAN_DHDController
        ...
        Public Function GetCHU_KY_HIEU_CHUAN_MS_VI_TRIs(ByVal strMS_MAY As String, ByVal strMS_PT As String) As DataTable
            ...
            Return objDataTable
        End Function
        Public Function GetHIEU_CHUAN_DHD_LOC(ByVal intNam As Integer, ByVal strMS_MAY As String, ByVal dongho As String, ByVal username As String) As DataTable
            Dim objDataTable As DataTable = New DataTable
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetHIEU_CHUAN_DHD_LOC", intNam, strMS_MAY, dongho, username))
            Return objDataTable
        End Function
