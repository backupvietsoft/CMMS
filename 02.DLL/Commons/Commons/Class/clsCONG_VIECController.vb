...
#Region "Public Method"
        ...
        Public Function AddCONG_VIEC(ByVal objCONG_VIECInfo As CONG_VIECInfo, ByVal Formname As String) As String
            Try
                SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "AddCONG_VIEC", objCONG_VIECInfo.MS_CV, objCONG_VIECInfo.MS_LOAI_CV,
                                objCONG_VIECInfo.MO_TA_CV, objCONG_VIECInfo.PATH_HD, objCONG_VIECInfo.MS_LOAI_MAY, objCONG_VIECInfo.THOI_GIAN_DU_KIEN,
                                objCONG_VIECInfo.THAO_TAC, objCONG_VIECInfo.TIEU_CHUAN_KT, objCONG_VIECInfo.MS_CM, objCONG_VIECInfo.MS_BT,
                                objCONG_VIECInfo.MA_CV, objCONG_VIECInfo.KY_HIEU_CV, objCONG_VIECInfo.AN_TOAN, objCONG_VIECInfo.DINH_MUC,
                ...
                SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "UPDATE_CONG_VIEC_LOG", objCONG_VIECInfo.MS_CV, Formname, Commons.Modules.UserName, 1)
                Return "True"
        ...
        Public Sub UpdateCONG_VIEC(ByVal objCONG_VIECInfo As CONG_VIECInfo, Optional ByVal FormName As String = "", Optional ByVal FormCaption As String = "")
            ...
            SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "UPDATE_CONG_VIEC_LOG", objCONG_VIECInfo.MS_CV, FormName, Commons.Modules.UserName, 2)
            'KY_HIEU_CV
            SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "UpdateCONG_VIEC",
               objCONG_VIECInfo.MS_CV, objCONG_VIECInfo.MS_LOAI_CV, objCONG_VIECInfo.MO_TA_CV, objCONG_VIECInfo.PATH_HD, objCONG_VIECInfo.MS_LOAI_MAY,
                objCONG_VIECInfo.THOI_GIAN_DU_KIEN, objCONG_VIECInfo.THAO_TAC, objCONG_VIECInfo.TIEU_CHUAN_KT, objCONG_VIECInfo.MS_CM,
                objCONG_VIECInfo.MS_BT, objCONG_VIECInfo.MA_CV, objCONG_VIECInfo.KY_HIEU_CV, objCONG_VIECInfo.AN_TOAN,
        ...
        Public Sub DeleteCONG_VIEC(ByVal MS_CV As Integer, ByVal formname As String)
            SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "UPDATE_CONG_VIEC_LOG", MS_CV, formname, Commons.Modules.UserName, 3)
            SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "DeleteCONG_VIEC", MS_CV)
        End Sub
