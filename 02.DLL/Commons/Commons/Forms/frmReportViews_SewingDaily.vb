...
Public Class frmReportViews_SewingDaily
    ...
    '        'Dim excelRange1 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(1, 1), excelWorkSheet.Cells(1, 10))
    '        'excelRange1.Merge()
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        If fileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Try
                Dim excelContent As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(9, 12), excelWorkSheet.Cells(vtbData.Rows.Count + 50, 13))
