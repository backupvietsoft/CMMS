...
Public Class frmReportViews_CheckList
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        If fileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Dim excelContent As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(7, 2), excelWorkSheet.Cells(count + 7, countColumn))
            excelContent.NumberFormat = "###,##0.00"
            Dim c = count + 7
            Dim excelTotal As Excel.Range = excelWorkSheet.Range("A" & c, "A" & c)
            excelWorkSheet.Cells(c, 1) = "Total"
            excelTotal.Font.Bold = True

            Dim excelSum As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(c, 2), excelWorkSheet.Cells(c, countColumn))
            Dim i As Integer
            Dim j As Integer
