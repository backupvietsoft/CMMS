...
Public Class frmReportViews_Budget
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcel.Click
        ...
        If fileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Dim excelRange As Excel.Range = excelWorkSheet.Range("A1", "A5")
            excelRange.EntireRow.Insert(Excel.XlInsertShiftDirection.xlShiftDown)
            Dim excelRange1 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(1, 1), excelWorkSheet.Cells(1, countColumn))
            excelRange1.Merge()
            ...
            Dim excelRange2 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(2, 1), excelWorkSheet.Cells(2, countColumn))
            excelRange2.Merge()
            ...
            Dim excelRange3 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(3, 1), excelWorkSheet.Cells(3, countColumn))
            excelRange3.Merge()
            excelRange3.Font.Name = "Tahoma"
            excelRange3.Font.Size = 11
            excelRange3.Font.Bold = True
            excelWorkSheet.Cells(3, 1) = Dept
            Dim excelRange4 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(4, 1), excelWorkSheet.Cells(4, countColumn))
            excelRange4.Merge()
            excelRange4.Font.Name = "Tahoma"
            excelRange4.Font.Size = 11
            excelRange4.Font.Bold = True
            excelWorkSheet.Cells(4, 1) = vMonth
            Dim excelRange5 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(5, 1), excelWorkSheet.Cells(5, countColumn))
            excelRange5.Merge()
            excelRange5.Font.Name = "Tahoma"
            excelRange5.Font.Size = 11
            excelRange5.Font.Bold = True
            excelWorkSheet.Cells(5, 1) = vUnit
            'Dim excelRange6 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(6, 1), excelWorkSheet.Cells(vtbData.Rows.Count + 6, TbSource.Columns.Count))
            'excelRange6.Font.Name = "Tahoma"
            'excelRange6.Font.Size = 9
            'excelRange6.Borders.Value = 1
            Dim excelRange7 As Excel.Range = excelWorkSheet.Range("A7", "A7")
            excelWorkSheet.Cells(7, 1) = vBUDGET
            Dim excelRange8 As Excel.Range = excelWorkSheet.Range("A8", "A8")
            excelWorkSheet.Cells(8, 1) = vUSED
            Dim excelRange9 As Excel.Range = excelWorkSheet.Range("A9", "A9")
            excelWorkSheet.Cells(9, 1) = vBALANCE

            Dim excelContent As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(7, 2), excelWorkSheet.Cells(count + 20, countColumn))
