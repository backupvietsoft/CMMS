...
Public Class frmrptDanhSachThietBiHetKhauHao
    Private SqlText As String = String.Empty

    Private Sub frmrptDanhSachThietBiHetKhauHao_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
        ...
        End Try
    End Sub
    Private Sub frmrptDanhSachThietBiHetKhauHao_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadLoaiTB()
        LoadNhaxuong()
    End Sub
    Sub LoadLoaiTB()
    ...
    Sub Printpreview4()
        ...
        While objReader.Read
            If objReader.Item("TONG") = 0 Then
                MsgBox(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptDanhSachThietBiHetKhauHao", "MsgKhongCoDuLieu", Commons.Modules.TypeLanguage), MsgBoxStyle.Exclamation)
                Cursor = Cursors.Default
                objReader.Close()
                GoTo KetThuc
            End If
        ...
        frmRepot.rptName = "rptDanhSachThietBiHetKhauHao"


        Dim vtbData As New DataTable()
        vtbData.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text, "SELECT * FROM rptDANH_SACH_THIET_BI_HET_KHAU_HAO_TMP"))
        vtbData.TableName = "rptDANH_SACH_THIET_BI_HET_KHAU_HAO_TMP"
        ...
        vtbTitle.TableName = "DANH_SACH_THIET_BI_HET_KHAU_HAO_TMP"
