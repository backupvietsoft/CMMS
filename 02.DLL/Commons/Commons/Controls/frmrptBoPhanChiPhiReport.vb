...
Public Class frmrptBoPhanChiPhiReport
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If fileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Dim excelRange1 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(1, 1), excelWorkSheet.Cells(1, vtbData.Columns.Count))
            excelRange1.Merge()
            ...
            Dim excelRange2 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(2, 1), excelWorkSheet.Cells(2, vtbData.Columns.Count))
            excelRange2.Merge()
            excelRange2.Font.Name = "Tahoma"
            excelRange2.Font.Size = 11
            excelRange2.Font.Bold = True
            excelWorkSheet.Cells(2, 1) = loaiChiuPhi
            Dim excelRange3 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(3, 1), excelWorkSheet.Cells(3, vtbData.Columns.Count))
            excelRange3.Merge()
            excelRange3.Font.Name = "Tahoma"
            excelRange3.Font.Size = 11
            excelRange3.Font.Bold = True
            excelWorkSheet.Cells(3, 1) = "DEPT"
            Dim excelRange4 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(4, 1), excelWorkSheet.Cells(4, vtbData.Columns.Count))
            excelRange4.Merge()
            ...
            Dim excelRange5 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(5, 1), excelWorkSheet.Cells(5, vtbData.Columns.Count))
            excelRange5.Merge()
