...
Public Class frmrptthoigiansuachuatrungbinh
    Public Shared baocao As Integer
    Public Shared tu As String
    Public Shared den As String
    Public Shared strNam As String

    Private Sub frmrptthoigiansuachuatrungbinh_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
    ...
    Private Sub frmrptthoigiansuachuatrungbinh_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case cboInTheo.SelectedIndex
            ...
            Case 1
                ...
                If tuquy.Length = 6 And denquy.Length = 6 Then
                    ...
                    '            DNgay = TNgay.AddMonths(3).AddDays(-1)
                    '        Else
                    '            TNgay = DNgay.AddDays(1)
                    '            DNgay = TNgay.AddMonths(3).AddDays(-1)
                    '        End If
                    '        Commons.Modules.SQLString = "INSERT INTO [dbo].NHOC_QUY ([QUY],[TU_NGAY],[DEN_NGAY]) " + _
                    '                " VALUES(N'" + i.ToString + "/" + strNam + "' ,  '" + _
                    '                TNgay.ToString("yyyyMMdd") + "',  '" + DNgay.ToString("yyyyMMdd") + "' )"
                    ...
                    '        End If
                    '        Commons.Modules.SQLString = "INSERT INTO [dbo].NHOC_QUY ([QUY],[TU_NGAY],[DEN_NGAY]) " + _
                    '            " VALUES(N'" + x.ToString + "/" + nam.ToString + "' ,  '" + _
                    '            TNgay.ToString("yyyyMMdd") + "',  '" + DNgay.ToString("yyyyMMdd") + "' )"
