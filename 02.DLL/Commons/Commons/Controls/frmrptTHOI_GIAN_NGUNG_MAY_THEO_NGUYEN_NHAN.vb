...
Public Class frmrptTHOI_GIAN_NGUNG_MAY_THEO_NGUYEN_NHAN
    ...
    Function CreateTG_NgungMayTheoNguyenNhan() As DataTable
        ...
        If Not sqlLine.Equals(String.Empty) And Not sqlCause.Equals(String.Empty) Then
            SqlText = "SELECT THOI_GIAN_NGUNG_MAY.MS_MAY,dbo.MAY.TEN_MAY, NGUYEN_NHAN_DUNG_MAY.MS_NGUYEN_NHAN, NGUYEN_NHAN_DUNG_MAY.TEN_NGUYEN_NHAN, THOI_GIAN_NGUNG_MAY.NGAY, " &
                             ...
                             "NHA_XUONG.Ten_N_XUONG, THOI_GIAN_NGUNG_MAY.GHI_CHU ,THOI_GIAN_NGUNG_MAY.NGUOI_GIAI_QUYET " &
    ...
    End Function                         '" LEFT OUTER JOIN dbo.CONG_NHAN ON dbo.THOI_GIAN_NGUNG_MAY.MS_CONG_NHAN = dbo.CONG_NHAN.MS_CONG_NHAN " & _
