...
Public Class frmrptHieuSuatSuDungMay
    ...
    Private Sub frmrptHieuSuatSuDungMay_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            LoadNhaxuong()
            LoadLoaiMay(cbxNhaXuong.EditValue)
    ...
    Sub LoadNhaxuong()
        Try
            KiemApp.MLoadCboTreeList(cbxNhaXuong, Commons.Modules.ObjSystems.MLoadDataNhaXuongTree(1), "MS_CHA", "MS_N_XUONG", "TEN_N_XUONG")
        Catch ex As Exception
        End Try
    End Sub
...
#End Region
    ...
    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        Try
            ...
            vtbData.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "H_GET_DATA_HIEU_SUAT_SU_DUNG_MAY", _Nam, cbxNhaXuong.EditValue, vLoaiMay))
    ...
    Private Sub cbxLoaiMay_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxLoaiMay.SelectedIndexChanged
