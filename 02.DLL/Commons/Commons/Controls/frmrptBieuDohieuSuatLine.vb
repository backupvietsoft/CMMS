...
Public Class frmrptBieuDohieuSuatLine
    Private vTuNgay As DateTime
    Private vDenNgay As DateTime

    Private Sub frmrptBieuDohieuSuatLine_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub mtxtTuNgay_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles mtxtTuNgay.Validating
        ...
        Catch ex As Exception
            MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "KO_DUNG_DINH_DANG", Commons.Modules.TypeLanguage))
            e.Cancel = True
        End Try
    ...
    Private Sub tbnThoat_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tbnThoat.Click
        Me.ParentForm.Close()
    End Sub

    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        If vTuNgay > vDenNgay Then
            MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "TN_PHAI_NHO_HON_DN", Commons.Modules.TypeLanguage))
            Exit Sub
        End If
        '' LAY DU LIEU 
        ...
        With ExcelSheets
            ...
            .Range("A1", "J1").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "TD1", Commons.Modules.TypeLanguage)

            .Range("A2", "J2").Font.Bold = True
            .Range("A2", "J2").Merge(True)
            .Range("A2", "J2").MergeCells = True
            .Range("A2", "J2").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "TD2", Commons.Modules.TypeLanguage)
            ...
            .Range("A3", "J4").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "TD3", Commons.Modules.TypeLanguage)
        End With
        ...
        For Each rThang As DataRow In vThang.Rows
            ...
            For Each rDThang As DataRow In vdrInMonth.ToTable.Rows
                With ExcelSheets
                    ...
                    'Dim vso As Double = (IIf((rDThang("SO_GIO_KH") - rDThang("SO_GIO_TONG_NM")) < 0, 0, (rDThang("SO_GIO_KH") - rDThang("SO_GIO_TONG_NM"))) / IIf(rDThang("SO_GIO_KH") = 0, 1, rDThang("SO_GIO_KH"))) * 100
                    .Range(vColum & vDong + i, vColum & vDong + i).Value = (IIf((rDThang("SO_GIO_KH") - rDThang("SO_GIO_TONG_NM")) < 0, 0, (rDThang("SO_GIO_KH") - rDThang("SO_GIO_TONG_NM"))) / IIf(rDThang("SO_GIO_KH") = 0, 1, rDThang("SO_GIO_KH"))) * 100
                    .Range(vColum & vDong + i, vColum & vDong + i).NumberFormat = "0.00"
                    i = i + 1
                End With
            Next
        ...
        xlChart.ChartTitle.Text = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDohieuSuatLine", "CHART_TITLE", Commons.Modules.TypeLanguage)
