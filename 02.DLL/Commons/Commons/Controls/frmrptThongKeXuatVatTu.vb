...
Public Class frmrptThongKeXuatVatTu
    ...
    Private Sub btnExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If fileDialog.ShowDialog() = DialogResult.OK Then
            ...
            Dim excelRange1 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(1, 1), excelWorkSheet.Cells(1, TbSource.Columns.Count))
            excelRange1.Merge()
            ...
            Dim excelRange2 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(2, 1), excelWorkSheet.Cells(2, TbSource.Columns.Count))
            excelRange2.Merge()
            excelRange2.Font.Name = "Tahoma"
            excelRange2.Font.Size = 11
            excelRange2.Font.Bold = True
            excelWorkSheet.Cells(2, 1) = "DEPT: MAINT"
            Dim excelRange3 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(3, 1), excelWorkSheet.Cells(3, TbSource.Columns.Count))
            excelRange3.Merge()
            ...
            Dim excelRange4 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(4, 1), excelWorkSheet.Cells(4, TbSource.Columns.Count))
            excelRange4.Merge()
            ...
            Dim excelRange5 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(5, 1), excelWorkSheet.Cells(5, TbSource.Columns.Count))
            excelRange5.Merge()
            ...
            Dim excelRange6 As Excel.Range = excelWorkSheet.Range(excelWorkSheet.Cells(6, 1), excelWorkSheet.Cells(TbSource.Rows.Count + 6, TbSource.Columns.Count))
