...
Public Class frmrptthoigiansuachuatrungbinh_new
    Public Shared baocao As Integer
    Public Shared tu As String
    Public Shared den As String
    Public Shared strNam As String

    Private Sub frmrptthoigiansuachuatrungbinh_new_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
