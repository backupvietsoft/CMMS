    ...
    Private Sub ViewData()
        If KiemTraData() Then
            ...
            If vtbNhaMay.Rows.Count > 0 Then
                noderoot = gvData.Nodes.Add(Nothing, "Nhà máy", vtbNhaMay.Rows(0)("CHI_PHI_PHU_TUNG_KH"), vtbNhaMay.Rows(0)("CHI_PHI_PHU_TUNG_KKH"),
                                            vtbNhaMay.Rows(0)("CHI_PHI_VAT_TU_KH"), vtbNhaMay.Rows(0)("CHI_PHI_VAT_TU_KKH"),
                                            vtbNhaMay.Rows(0)("CHI_PHI_NHAN_CONG_KH"), vtbNhaMay.Rows(0)("CHI_PHI_NHAN_CONG_KKH"),
                                            vtbNhaMay.Rows(0)("CHI_PHI_DV_KH"), vtbNhaMay.Rows(0)("CHI_PHI_DV_KKH"),
                                            vtbNhaMay.Rows(0)("CHI_PHI_KHAC_KH"), vtbNhaMay.Rows(0)("CHI_PHI_KHAC_KKH"), vtbNhaMay.Rows(0)("CHI_PHI_HANG_NGAY"),
            ...
            For Each vRowNx As DataRow In vtbNx.Rows
                ...
                Dim node As TreeGridNode = noderoot.Nodes.Add(Nothing, vRowNx("TEN_N_XUONG").ToString, vRowNx("CHI_PHI_PHU_TUNG_KH"), vRowNx("CHI_PHI_PHU_TUNG_KKH"),
                        vRowNx("CHI_PHI_VAT_TU_KH"), vRowNx("CHI_PHI_VAT_TU_KKH"),
                        vRowNx("CHI_PHI_NHAN_CONG_KH"), vRowNx("CHI_PHI_NHAN_CONG_KKH"),
                        vRowNx("CHI_PHI_DV_KH"), vRowNx("CHI_PHI_DV_KKH"),
                        vRowNx("CHI_PHI_KHAC_KH"), vRowNx("CHI_PHI_KHAC_KKH"),
                        vRowNx("CHI_PHI_HANG_NGAY"),
                ...
                For Each vRowLm As DataRow In vtbLoaiMay.Rows
                    If c3 = 0 Then
                        node = node.Nodes.Add(Nothing, vRowLm("TEN_LOAI_MAY").ToString, vRowLm("CHI_PHI_PHU_TUNG_KH"), vRowLm("CHI_PHI_PHU_TUNG_KKH"),
                                              vRowLm("CHI_PHI_VAT_TU_KH"), vRowLm("CHI_PHI_VAT_TU_KKH"),
                                              vRowLm("CHI_PHI_NHAN_CONG_KH"), vRowLm("CHI_PHI_NHAN_CONG_KKH"),
                                              vRowLm("CHI_PHI_DV_KH"), vRowLm("CHI_PHI_DV_KKH"),
                                              vRowLm("CHI_PHI_KHAC_KH"), vRowLm("CHI_PHI_KHAC_KKH"),
                                              vRowLm("CHI_PHI_HANG_NGAY"),
                        ...
                        For Each vRowNm As DataRow In vtbNhomMay.Rows
                            If c4 = 0 Then
                                ...
                                node = node.Nodes.Add(Nothing, vRowNm("TEN_NHOM_MAY").ToString, vRowNm("CHI_PHI_PHU_TUNG_KH"), vRowNm("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowNm("CHI_PHI_VAT_TU_KH"), vRowNm("CHI_PHI_VAT_TU_KKH"),
                                                      vRowNm("CHI_PHI_NHAN_CONG_KH"), vRowNm("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowNm("CHI_PHI_DV_KH"), vRowNm("CHI_PHI_DV_KKH"),
                                                      vRowNm("CHI_PHI_KHAC_KH"), vRowNm("CHI_PHI_KHAC_KKH"),
                                                      vRowNm("CHI_PHI_HANG_NGAY"),
                                ...
                                For Each vRowMay As DataRow In vtbMay.Rows
                                    If c5 = 0 Then
                                        ...
                                        node = node.Nodes.Add(Nothing, vRowMay("MS_MAY").ToString, vRowMay("CHI_PHI_PHU_TUNG_KH"), vRowMay("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowMay("CHI_PHI_VAT_TU_KH"), vRowMay("CHI_PHI_VAT_TU_KKH"),
                                                      vRowMay("CHI_PHI_NHAN_CONG_KH"), vRowMay("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowMay("CHI_PHI_DV_KH"), vRowMay("CHI_PHI_DV_KKH"),
                                                      vRowMay("CHI_PHI_KHAC_KH"), vRowMay("CHI_PHI_KHAC_KKH"), vRowMay("CHI_PHI_HANG_NGAY"),
                                        ...
                                        For Each vRowPBT As DataRow In vtbPhieuBaotri.Rows
                                            If c6 = 0 Then
                                                node = node.Nodes.Add(Nothing, vRowPBT("MS_PHIEU_BAO_TRI").ToString, vRowPBT("CHI_PHI_PHU_TUNG_KH"), vRowPBT("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowPBT("CHI_PHI_VAT_TU_KH"), vRowPBT("CHI_PHI_VAT_TU_KKH"),
                                                      vRowPBT("CHI_PHI_NHAN_CONG_KH"), vRowPBT("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowPBT("CHI_PHI_DV_KH"), vRowPBT("CHI_PHI_DV_KKH"),
                                                      vRowPBT("CHI_PHI_KHAC_KH"), vRowPBT("CHI_PHI_KHAC_KKH"), vRowPBT("CHI_PHI_HANG_NGAY"),
                                            ...
                                            Else
                                                node = nodeCap6
                                                node = node.Parent.Nodes.Add(Nothing, vRowPBT("MS_PHIEU_BAO_TRI").ToString, vRowPBT("CHI_PHI_PHU_TUNG_KH"), vRowPBT("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowPBT("CHI_PHI_VAT_TU_KH"), vRowPBT("CHI_PHI_VAT_TU_KKH"),
                                                      vRowPBT("CHI_PHI_NHAN_CONG_KH"), vRowPBT("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowPBT("CHI_PHI_DV_KH"), vRowPBT("CHI_PHI_DV_KKH"),
                                                      vRowPBT("CHI_PHI_KHAC_KH"), vRowPBT("CHI_PHI_KHAC_KKH"),
                                                      vRowPBT("CHI_PHI_HANG_NGAY"),
                                                      vRowPBT("TONG_KH"), vRowPBT("TONG_KKH"), vRowPBT("TONG"))
                                                node.ImageIndex = 0
                                            End If
                                    ...
                                    Else
                                        ...
                                        'node.DefaultCellStyle.Font = boldFont
                                        'node.DefaultCellStyle.ForeColor = Color.Green
                                        node = node.Parent.Nodes.Add(Nothing, vRowMay("MS_MAY").ToString, vRowMay("CHI_PHI_PHU_TUNG_KH"), vRowMay("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowMay("CHI_PHI_VAT_TU_KH"), vRowMay("CHI_PHI_VAT_TU_KKH"),
                                                      vRowMay("CHI_PHI_NHAN_CONG_KH"), vRowMay("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowMay("CHI_PHI_DV_KH"), vRowMay("CHI_PHI_DV_KKH"),
                                                      vRowMay("CHI_PHI_KHAC_KH"), vRowMay("CHI_PHI_KHAC_KKH"), vRowMay("CHI_PHI_HANG_NGAY"),
                            ...
                            Else
                                ...
                                node = node.Parent.Nodes.Add(Nothing, vRowNm("TEN_NHOM_MAY").ToString, vRowNm("CHI_PHI_PHU_TUNG_KH"), vRowNm("CHI_PHI_PHU_TUNG_KKH"),
                                                      vRowNm("CHI_PHI_VAT_TU_KH"), vRowNm("CHI_PHI_VAT_TU_KKH"),
                                                      vRowNm("CHI_PHI_NHAN_CONG_KH"), vRowNm("CHI_PHI_NHAN_CONG_KKH"),
                                                      vRowNm("CHI_PHI_DV_KH"), vRowNm("CHI_PHI_DV_KKH"),
                                                      vRowNm("CHI_PHI_KHAC_KH"), vRowNm("CHI_PHI_KHAC_KKH"), vRowNm("CHI_PHI_HANG_NGAY"),
                                                      vRowNm("TONG_KH"), vRowNm("TONG_KKH"), vRowNm("TONG"))
                                node.ImageIndex = 0
                                Dim vtbMay As New DataTable
                                vtbMay = DataMayByLoaiMay(vRowNx("MS_N_XUONG").ToString, vRowLm("MS_LOAI_MAY").ToString, vRowNm("MS_NHOM_MAY").ToString)
