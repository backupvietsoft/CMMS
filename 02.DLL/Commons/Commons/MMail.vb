...
#Region "Goi Mail"
    ...
    'iiiiiiiiiii
    Public Function MSendEmail(ByVal SendTo As String, ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String, ByVal AttachmentPath As String, ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        ...
        Try
            ...
            If result = True Then
                Try
                    ...
                    message.From = New MailAddress(SendFrom, sMailName)
                    result = True
                    If SendTo.Trim() <> "" Then
    ...
    Public Function MSendEmail(ByVal SendTo As String, ByVal SendCC As String,
                                ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                                ByVal AttachmentPath As String, ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        Try
            If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
                SendTo = "ecomaint.cmms@gmail.com"
                SendCC = ""
            ...
            If result = True Then
                Try
                    ...
                    Return ""
                Catch ex As Exception
                    Return ex.Message + " - " + AttachmentPath
                End Try
            Else
                Return "Email not sent"
            End If
    ...
    Public Function MSendEmail(ByVal SendTo As String, ByVal SendCC As String, ByVal SendBCC As String,
                            ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                            ByVal AttachmentPath As String, ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        Try
            If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
...
#Region "Goi Mail"
    Public Function MGoiMail(ByVal xlWorkBook As Excel.Workbook, ByVal sPath As String, ByVal sPathFileSend As String, ByVal sMail As String, ByVal sMailCC As String, ByVal sTieuDe As String,
     ByVal sBody As String, ByRef sKetQuaSent As String) As [Boolean]
        Try
            xlWorkBook.SaveAs(sPathFileSend, Excel.XlFileFormat.xlWorkbookNormal, Type.Missing, Type.Missing, False, False,
            ...
            If sMailCC = "" Then
                sKetQua = Commons.Modules.MMail.MSendEmail(sMail, Commons.Modules.sMailFrom, Commons.Modules.sMailFromPass, sTieuDe, sBody, sPathFileSend,
                 Commons.Modules.sMailFromSmtp, Commons.Modules.sMailFromPort)
            Else
                sKetQua = Commons.Modules.MMail.MSendEmail(sMail, sMailCC, Commons.Modules.sMailFrom, Commons.Modules.sMailFromPass, sTieuDe, sBody,
...
#Region "Goi Mail Co ProgressBar"
    ...
    Public Function MSendEmail(ByVal SendTo As String,
                                ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                                ByVal AttachmentPath As String, ByVal sSmtp As String, ByVal sPort As String,
                                ByVal prbBar As DevExpress.XtraEditors.ProgressBarControl, Optional sMailName As String = "CMMS") As String
        If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
            SendTo = "ecomaint.cmms@gmail.com"
        End If
        Commons.Modules.ObjSystems.MBoMailUser(SendTo)
...
#Region "Dua File Vao CSDL"
    Public Function CapNhapMailVaoCSDL(ByVal sFileName As String, ByVal sPath As String, ByVal sMailTo As String, ByVal sMailCC As String, ByVal sMailBCC As String, ByVal sTieuDe As String,
     ByVal sBody As String, ByRef sKetQua As String) As Boolean
        Try
            ...
            Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "MAddMailSent", sFileName, Commons.Modules.sDDanMail + "\" & sFileName, sMailTo, sMailCC,
    ...
    Public Function CapNhapMailVaoCSDL(ByVal sFileName As String, ByVal sPath As String, ByVal sMailTo As String, ByVal sMailCC As String, ByVal sMailBCC As String, ByVal sTieuDe As String,
        ...
        Try
            ...
            Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, "MAddMailSent", sFileName, sPathLuu + "\" & sFileName, sMailTo, sMailCC,
             sMailBCC, sTieuDe, sBody)
        Catch ex As Exception
            sKetQua = ex.Message
            Return False
...
#Region "Goi Mail Khong Attachment"
    ...
    Public Function MSendEmailNotAttachment(ByVal SendTo As String,
                                ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                                ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        Try
            If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
                SendTo = "ecomaint.cmms@gmail.com"
            End If
    ...
    Public Function MSendEmailNotAttachment(ByVal SendTo As String, ByVal SendCC As String,
                                ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                                ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        Try
            If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
    ...
    Public Function MSendEmailNotAttachment(ByVal SendTo As String, ByVal SendCC As String, ByVal SendBCC As String,
                            ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                            ByVal sSmtp As String, ByVal sPort As String, Optional sMailName As String = "CMMS") As String
        Try
            If myHost.ToUpper().ToString() = "mashilove".ToUpper.ToString() Then
...
#Region "Goi Mail"
    Public Function MGoiMailNotAttachment(ByVal sMail As String, ByVal sMailCC As String, ByVal sTieuDe As String,
     ByVal sBody As String, ByRef sKetQuaSent As String) As [Boolean]
        Try
            Dim sKetQua As String

            If sMailCC = "" Then
                sKetQua = Commons.Modules.MMail.MSendEmailNotAttachment(sMail, Commons.Modules.sMailFrom, Commons.Modules.sMailFromPass, sTieuDe, sBody,
                 Commons.Modules.sMailFromSmtp, Commons.Modules.sMailFromPort, sMailName:="CMMS")
            Else
                sKetQua = Commons.Modules.MMail.MSendEmailNotAttachment(sMail, sMailCC, Commons.Modules.sMailFrom, Commons.Modules.sMailFromPass, sTieuDe, sBody,
                 Commons.Modules.sMailFromSmtp, Commons.Modules.sMailFromPort, sMailName:="CMMS")
            End If
...
#Region "Goi Mail Co ProgressBar Khong Attachment"
    ...
    Public Function MSendEmailNotAttachment(ByVal SendTo As String,
                                ByVal SendFrom As String, ByVal SendFromPass As String, ByVal sSubject As String, ByVal sBody As String,
                                ByVal sSmtp As String, ByVal sPort As String,
                                ByVal prbBar As DevExpress.XtraEditors.ProgressBarControl, Optional sMailName As String = "CMMS") As String
        Dim iViTri As Integer
        iViTri = prbBar.Position + 9
        Try
