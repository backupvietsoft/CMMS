...
#Region "PRIVATE"
        ...
        End Sub
        Public Function AddGIAM_SAT_TINH_TRANG_1(ByVal objGIAM_SAT_TINH_TRANGInfo As GIAM_SAT_TINH_TRANGInfo) As Integer
            Return SqlHelper.ExecuteScalar(Commons.IConnections.ConnectionString, "AddGIAM_SAT_TINH_TRANG_1", objGIAM_SAT_TINH_TRANGInfo.GIO_KT, objGIAM_SAT_TINH_TRANGInfo.DEN_GIO, objGIAM_SAT_TINH_TRANGInfo.NGAY_KT, objGIAM_SAT_TINH_TRANGInfo.MS_CONG_NHAN)
        End Function
        Public Sub UpdateGIAM_SAT_TINH_TRANG(ByVal objGIAM_SAT_TINH_TRANGInfo As GIAM_SAT_TINH_TRANGInfo)
            SqlHelper.ExecuteScalar(Commons.IConnections.ConnectionString, "UpdateGIAM_SAT_TINH_TRANG", objGIAM_SAT_TINH_TRANGInfo.STT, objGIAM_SAT_TINH_TRANGInfo.GIO_KT, objGIAM_SAT_TINH_TRANGInfo.DEN_GIO, objGIAM_SAT_TINH_TRANGInfo.NGAY_KT, objGIAM_SAT_TINH_TRANGInfo.MS_CONG_NHAN)
        End Sub
#End Region
