...
#Region "Public Method"
    ...
    Public Sub AddNguoidaidien(ByVal objkhachhanginfo As KHACH_HANGInfo, ByVal FORMNAME As String)
        Dim STT As Integer = CType(SqlHelper.ExecuteScalar(Commons.IConnections.ConnectionString, "AddNGUOI_DAI_DIEN", _
             objkhachhanginfo.MS_KH, objkhachhanginfo.NGUOI_DAI_DIEN, objkhachhanginfo.CHUC_VU, _
             objkhachhanginfo.DI_DONG, objkhachhanginfo.DIEN_THOAI, objkhachhanginfo.DIEN_THOAI_NHA, _
