...
#Region "Public Method"
        ...
        Public Sub UpdateBO_PHAN_CHIU_PHI(ByVal objBO_PHAN_CHIU_PHIInfo As BO_PHAN_CHIU_PHIInfo, ByVal OLD_TEN_BP_CHIU_PHI As String)
            ...
            objBO_PHAN_CHIU_PHIInfo.LOAI_CHI_PHI, objBO_PHAN_CHIU_PHIInfo.MSDV, objBO_PHAN_CHIU_PHIInfo.GHI_CHU, OLD_TEN_BP_CHIU_PHI, _
        ...
        Public Sub InsertBO_PHAN_CHIU_PHI_LOG(ByVal ID As Integer, ByVal FORM_NAME As String, ByVal USER_NAME As String, ByVal THAO_TAC As Integer)
            SqlHelper.ExecuteScalar(Commons.IConnections.ConnectionString, "UPDATE_BO_PHAN_CHIU_PHI_LOG", ID, FORM_NAME, USER_NAME, THAO_TAC)
        End Sub
        Public Sub DeleteBO_PHAN_CHIU_PHI(ByVal MS_BP_CHIU_PHI As Integer, ByVal FORMNAME As String)
            SqlHelper.ExecuteScalar(Commons.IConnections.ConnectionString, "UPDATE_BO_PHAN_CHIU_PHI_LOG", MS_BP_CHIU_PHI, FORMNAME, Commons.Modules.UserName, 3)
