...
Public Class frmrptKeHoachSuaChuaThietBi_KHTT_KKTL
    Dim v_all As DataTable = New DataTable()
    Private Sub frmrptKeHoachSuaChuaThietBi_KHTT_KKTL_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Function Get_DataTable(ByVal MS_N_Xuong As String, ByVal tungay As Date, ByVal denngay As Date) As System.Data.DataTable
        ...
        If MS_N_Xuong <> "-1" Then
            ...
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, _
                "[getKeHoachsuachuathietbi_KHTT_NEW]", tungay, denngay, _
                MS_N_Xuong, Commons.Modules.UserName, Commons.Modules.UserName))
        ...
        Else
            Dim objDataTable As System.Data.DataTable = New System.Data.DataTable
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, _
                "[getKeHoachsuachuathietbi_KHTT_NEW]", tungay, denngay, MS_N_Xuong, _
