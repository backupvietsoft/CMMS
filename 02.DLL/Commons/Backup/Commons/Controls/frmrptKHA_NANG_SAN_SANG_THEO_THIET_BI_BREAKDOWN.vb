...
Public Class frmrptKHA_NANG_SAN_SANG_THEO_THIET_BI_BREAKDOWN

    Private Sub rptKHA_NANG_SAN_SANG_THEO_THIET_BI_BREAKDOWN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        Try
            ...
            With ExcelSheets
                ...
                .Cells(vRow, 1) = "KHẢ NĂNG SẴN SÀNG THEO DÂY CHUYỀN (ONLY BREAKDOWN)"
                vRow = vRow + 1
            ...
            For j As Integer = 0 To gvDaychuyen.Rows.Count - 1
                If (Not gvDaychuyen.Rows(j).Cells("clChonDaychuyen").Value Is Nothing) Then
                    If Convert.ToBoolean(gvDaychuyen.Rows(j).Cells("clChonDaychuyen").Value) Then
                        ...
                        " AND MS_HE_THONG = " & gvDaychuyen.Rows(j).Cells("clMsDaychuyen").Value & " AND THOI_GIAN_SUA_CHUA > 0 AND ( HU_HONG = 1) "
                            ...
                            For k As Integer = 0 To vTablemay.Rows.Count - 1
                                ...
                                While vNgay.Year <= vDen.Year
                                    ...
                                    Else
                                        ...
                                        " WHERE NGAY >= '" & vTu.ToString("MM/dd/yyyy") & "'  AND NGAY < '" & vDen.ToString("MM/dd/yyyy") & "'AND YEAR (THANG) = YEAR (NGAY) AND MONTH (THANG) = MONTH (NGAY) AND (HU_HONG = 1 )And Month(NGAY) = " & vNgay.Month & " AND YEAR(NGAY) = " & vNgay.Year & " " & _
