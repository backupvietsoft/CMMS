...
Public Class frmrptKeHoachBaoTriTrongTuan
    ...
    Sub Bind_cboNhaxuong()
        ...
        _table = Commons.Modules.ObjSystems.MLoadDataNhaXuong(1)
        Commons.Modules.ObjSystems.MLoadLookUpEdit(cboNhaXuongPBT, _table, "MS_N_XUONG", "TEN_N_XUONG", "")
    ...
    Private Function ShowrptKeHoachBaoTriTrongTuan() As DataTable
        Try
            ...
            Else
                ...
                objTB.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "sBCKeHoachBaoTriTuan", Commons.Modules.UserName, _
    ...
    Private Function CreateTieuDe() As DataTable
        ...
        dtR.Item("N6") = "N6"
        dtR.Item("N7") = "N7"
        dtR.Item("NhaXuong") = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptKeHoachBaoTriTrongTuan", "NhaXuong", Commons.Modules.TypeLanguage) & " " & cboNhaXuongPBT.Text.Trim
