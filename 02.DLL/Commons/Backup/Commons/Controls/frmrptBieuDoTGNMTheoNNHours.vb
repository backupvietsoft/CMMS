...
Public Class frmrptBieuDoTGNMTheoNNHours
    Private vTuNgay As DateTime
    Private vDenNgay As DateTime
    Dim v_all As System.Data.DataTable = New System.Data.DataTable()

    Private Sub frmrptBieuDoTGNMTheoNNHours_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        Try
            SqlHelper.ExecuteNonQuery(Commons.IConnections.ConnectionString, CommandType.Text, "DROP TABLE dbo.NGUYEN_NHAN_CHON_TMP")
        Catch ex As Exception
        End Try
    End Sub
    Private Sub frmrptBieuDoTGNMTheoNNHours_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        Try
            ...
            If vTuNgay > vDenNgay Then
                MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "TN_PHAI_NHO_HON_DN", Commons.Modules.TypeLanguage))
                Exit Sub
            End If

            If CheckSelectNN() = False Then
                MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "CHUA_CHON_NN", Commons.Modules.TypeLanguage))
                Exit Sub
            End If
            ...
            If vtbData.Rows.Count <= 0 Then
                MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "NoDataToPrint", Commons.Modules.TypeLanguage))
                Exit Sub
            End If
            ...
            With ExcelSheets
                ...
                .Range("A1", "J1").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "TD1", Commons.Modules.TypeLanguage)

                .Range("A2", "J2").Font.Bold = True
                .Range("A2", "J2").Merge(True)
                .Range("A2", "J2").MergeCells = True
                .Range("A2", "J2").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "TD2", Commons.Modules.TypeLanguage)
                ...
                .Range("A3", "J4").Value = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "TD3", Commons.Modules.TypeLanguage)
            End With
            ...
            For Each rThang As DataRow In vThang.Rows
                ...
                For Each rDThang As DataRow In vdrInMonth.ToTable.Rows
                    With ExcelSheets
                        ...
                        .Range(vColum & vDong + i, vColum & vDong + i).Value = rDThang("SO_GIO")
    ...
    Private Sub mtxtTuNgay_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles mtxtTuNgay.Validating
        ...
        Catch ex As Exception
            MessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptBieuDoTGNMTheoNNHours", "KO_DUNG_DINH_DANG", Commons.Modules.TypeLanguage))
            e.Cancel = True
        End Try
...
#Region "Nhu Y"
    ...
    Function Get_DataTable(ByVal MS_N_Xuong As String, ByVal tungay As Date, ByVal denngay As Date) As System.Data.DataTable
        ...
        If MS_N_Xuong <> "-1" Then
            ...
            objDataTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "[H_BDTGNM_THEO_NN_GET_DATA_NEW]", tungay, denngay))
