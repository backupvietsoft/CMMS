...
Public Class frmrptThongKeTanSuatNgungMay
    Dim v_all As DataTable = New DataTable()
    Dim vtbNx As DataTable = New DataTable()
    Private Sub frmrptThongKeTanSuatNgungMay_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnThucHien_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnThucHien.Click
        If dtTu.Value > dtDen.Value Then
            MsgBox(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "rptThongKeTanSuatNgungMay", "TNPhaiNhoHonDN", Commons.Modules.TypeLanguage))
            dtTu.Focus()
            Exit Sub
        End If
        Try
                                ...
                                With ExcelSheets
                                    ...
                                    For k As Integer = 0 To vTablemay.Rows.Count - 1
                                        ...
                                        While vNgay < dtDen.Value
                                            ...
                                            Dim strss As String = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND NGAY = '" & vNgay.ToString("MM/dd/yyyy") & "' GROUP BY MS_MAY "
                                    ...
                                    With ExcelSheets
                                        ...
                                        For k As Integer = 0 To vTablemay.Rows.Count - 1
                                            ...
                                            While vNgay.Year <= dtDen.Value.Year
                                                ...
                                                If vNgay.Year = dtDen.Value.Year Then
                                                    If (vNgay.Month <= dtDen.Value.Month) Then
                                                        Dim strss As String = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND MONTH (NGAY) = " & vNgay.Month & " AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                        tbTb.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text, strss))
                                                        Try
                                                            .Cells(vRow + k + 1, vColum).BorderAround(ColorIndex:=1, Weight:=Excel.XlBorderWeight.xlThin)
                                                            .Cells(vRow + k + 1, vColum) = tbTb.Rows(0)("TG_DUNG").ToString().Trim()
                                        ...
                                        With ExcelSheets
                                            ...
                                            For k As Integer = 0 To vTablemay.Rows.Count - 1
                                                ...
                                                While vNgay.Year <= dtDen.Value.Year
                                                    ...
                                                    End If
                                                    If (vNgay.Month > 9) Then
                                                        strss = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND MONTH (NGAY) >= 10 AND MONTH (NGAY) <= 12 AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                    Else
                                                        If (vNgay.Month > 6) Then
                                                            strss = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND MONTH (NGAY) >= 7 AND MONTH (NGAY) <= 9 AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                        Else
                                                            If (vNgay.Month > 3) Then
                                                                strss = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND MONTH (NGAY) >= 3 AND  MONTH (NGAY) <= 6 AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                            Else
                                                                strss = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND MONTH (NGAY) <= 2 AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                            End If
                                                        End If
                                                    End If
                                        ...
                                        If rdoNam.Checked Then
                                            With ExcelSheets
                                                ...
                                                For k As Integer = 0 To vTablemay.Rows.Count - 1
                                                    ...
                                                    While vNgay.Year <= dtDen.Value.Year
                                                        Dim tbTb As DataTable = New DataTable()
                                                        Dim strss As String = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "' AND ( NGAY >= '" & dtTu.Value.ToString("MM/dd/yyyy") & "' AND NGAY < '" & dtDen.Value.ToString("MM/dd/yyyy") & "' AND YEAR (NGAY) = " & vNgay.Year & ") GROUP BY MS_MAY "
                                                        tbTb.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text, strss))
                                                        Try
                                                            .Cells(vRow + k + 1, vColum).BorderAround(ColorIndex:=1, Weight:=Excel.XlBorderWeight.xlThin)
                                                            .Cells(vRow + k + 1, vColum) = tbTb.Rows(0)("TG_DUNG").ToString().Trim()
                                            ...
                                            If rdoTuan.Checked Then
                                                With ExcelSheets
                                                    ...
                                                    For k As Integer = 0 To vTablemay.Rows.Count - 1
                                                        ...
                                                        While vNgay <= dtDen.Value
                                                            Dim tbTb As DataTable = New DataTable()
                                                            Dim strss As String = "SELECT COUNT ( * )  AS TG_DUNG FROM dbo.THOI_GIAN_NGUNG_MAY WHERE THOI_GIAN_NGUNG_MAY.MS_N_XUONG = '" & vtbNx.Rows(j)("MS_N_XUONG") & "' AND  dbo.THOI_GIAN_NGUNG_MAY.MS_NGUYEN_NHAN = " & gvNguyennhan.Rows(i).Cells("clMsnguyennhan").Value & " AND MS_MAY = '" & vTablemay.Rows(k)("MS_MAY") & "'  AND NGAY >= '" & vNgay.AddDays(-Weekday(vNgay)).ToString("MM/dd/yyyy") & "' AND NGAY <= '" & vNgay.AddDays(-Weekday(vNgay)).AddDays(7).ToString("MM/dd/yyyy") & "' GROUP BY MS_MAY "
                                                            tbTb.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, CommandType.Text, strss))
                                                            Try
                                                                .Cells(vRow + k + 1, vColum).BorderAround(ColorIndex:=1, Weight:=Excel.XlBorderWeight.xlThin)
                                                                .Cells(vRow + k + 1, vColum) = tbTb.Rows(0)("TG_DUNG").ToString().Trim()
