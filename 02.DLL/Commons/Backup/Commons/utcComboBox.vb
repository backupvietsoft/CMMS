            ...
            Else
                Try
                    If Param2 = "" Then
                        dtTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, StoreName, _Param))
                    Else
                        dtTable.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, StoreName, _Param, _Param2))
                    End If
...
#Region "Private methods"
    ...
    Sub ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ID = "0" And IsNew = True Then
            Dim objForm As Object = QDynamicInvoke.InvokeNewForm(Application.ExecutablePath, _className, "ShowDialog", Nothing)
