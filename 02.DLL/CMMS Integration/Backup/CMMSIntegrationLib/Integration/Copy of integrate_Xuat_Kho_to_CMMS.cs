...
{
    public class integrate_Xuat_Kho_to_CMMS_copy
    {
        public integrate_Xuat_Kho_to_CMMS_copy()
        {
        }
        ...
        public string ExecSynchronizeXUAT_KHO_To_DBCMMS()
        {
            try
            {
                ...
                if (Xuat_KhoTransfer.Rows.Count > 0)
                {
                    ...
                    {
                        XUAT_KHO_copy _item = new XUAT_KHO_copy();
        ...
        private bool UpdateToDBCMMS(XUAT_KHO_copy _item)
        {
            try
            {
                ...
                try
                {
                    ...
                    SqlHelper.ExecuteNonQuery(sqlTrans, "INTEGRATION_XUAT_KHO_HEADER_UPDATE", _item.STT, _item.MS_DH_XUAT_PT, _item.SO_PHIEU_XN, _item.GIO, _item.NGAY,
                        _item.MS_KHO, _item.MS_DANG_XUAT, _item.NGUOI_NHAN, _item.NGAY_CHUNG_TU, _item.SO_CHUNG_TU, _item.GHI_CHU, _item.THU_KHO, _item.NGUOI_LAP , 
                        _item.MS_MAY ,_item.MS_BP_CHIU_PHI , _item.MS_PHIEU_BAO_TRI);
    ...
    public class XUAT_KHO_copy
    {
        public XUAT_KHO_copy() { }
