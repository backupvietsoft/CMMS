...
CREATE TABLE [dbo].[SYN_TB_NHAP_KHO_CMMS](
 ...
 CONSTRAINT [PK_SYN_TB_NHAP_KHO_CMMS] PRIMARY KEY CLUSTERED 
(
	[STT] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]

ALTER TABLE [dbo].[SYN_TB_NHAP_KHO_CMMS] ADD  CONSTRAINT [DF_SYN_TB_NHAP_KHO_CMMS_DA_CHUYEN]  DEFAULT ((0)) FOR [DA_CHUYEN]
