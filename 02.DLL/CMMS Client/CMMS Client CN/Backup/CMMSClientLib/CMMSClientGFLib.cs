...
namespace CMMSClientGFLib
{
    public class CMMSClientGFLib
    {
        ...
        public string iPServer = "192.168.1.101";
        ...
        public CMMSClientGFLib(string clientId, string ipAddress, int sendPort, int receivePort, string DefaultPath)
        {
            this.clientId = clientId;
            CMMSClientGFLib.ipAddress = ipAddress;
            CMMSClientGFLib.portSend = sendPort;
            CMMSClientGFLib.portReceive = receivePort;
            CMMSClientGFLib.outPathDefault = DefaultPath;
        }
        /// <summary>
        ...
        public CMMSClientGFLib(string clientId, string ipAddress, string DefaultPath)
        {
            this.clientId = clientId;
            outPathDefault = DefaultPath;
            CMMSClientGFLib.ipAddress = ipAddress;
            CMMSClientGFLib.portSend = 9050;
            CMMSClientGFLib.portReceive = 9051;
        ...
        public string ReceiveInfo(string IPSer)
        {
            ...
            {
                Socket server = null;
                IPEndPoint ipEnd = new IPEndPoint(IPAddress.Parse(IPSer), CMMSClientGFLib.portReceive);
        ...
        public string ReceiveHDDSerial(string IPSer)
        {
            ...
            {
                Socket server = null;
                IPEndPoint ipEnd = new IPEndPoint(IPAddress.Parse(iPServer), CMMSClientGFLib.portReceive);


                IPEndPoint ipEnad = new IPEndPoint(IPAddress.Parse(iPServer), CMMSClientGFLib.portReceive);
