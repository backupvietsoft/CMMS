...
Public Class rptDeXuatMuaHang_VMPACK
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDeXuatMuaHang_VMPACK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeXuatMuaHang_VMPACK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeXuatMuaHang_VMPACK = New rptDeXuatMuaHang_VMPACK
        rpt.Site = Me.Site
        Return rpt
    End Function
