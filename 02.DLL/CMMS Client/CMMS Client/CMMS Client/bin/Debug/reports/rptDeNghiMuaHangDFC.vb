...
Public Class rptDeNghiMuaHangDFC
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDeNghiMuaHangDFC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeNghiMuaHangDFC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeNghiMuaHangDFC = New rptDeNghiMuaHangDFC
        rpt.Site = Me.Site
        Return rpt
    End Function
