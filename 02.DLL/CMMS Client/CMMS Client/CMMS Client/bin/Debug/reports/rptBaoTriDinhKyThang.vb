...
Public Class rptBaoTriDinhKyThang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBaoTriDinhKyThang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBaoTriDinhKyThang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBaoTriDinhKyThang = New rptBaoTriDinhKyThang
        rpt.Site = Me.Site
        Return rpt
    End Function
