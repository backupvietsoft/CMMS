...
Public Class rptPhieuNhapKho_DUYTAN
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPhieuNhapKho_DUYTAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPhieuNhapKho_DUYTAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPhieuNhapKho_DUYTAN = New rptPhieuNhapKho_DUYTAN
        rpt.Site = Me.Site
        Return rpt
    End Function
