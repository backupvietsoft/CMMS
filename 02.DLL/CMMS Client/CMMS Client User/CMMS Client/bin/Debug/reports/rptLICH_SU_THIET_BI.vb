...
Public Class rptLICH_SU_THIET_BI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLICH_SU_THIET_BI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLICH_SU_THIET_BI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLICH_SU_THIET_BI = New rptLICH_SU_THIET_BI
        rpt.Site = Me.Site
        Return rpt
    End Function
