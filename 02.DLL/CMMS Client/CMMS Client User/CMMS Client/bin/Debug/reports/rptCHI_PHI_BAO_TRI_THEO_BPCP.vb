...
Public Class rptCHI_PHI_BAO_TRI_THEO_BPCP
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCHI_PHI_BAO_TRI_THEO_BPCP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCHI_PHI_BAO_TRI_THEO_BPCP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCHI_PHI_BAO_TRI_THEO_BPCP = New rptCHI_PHI_BAO_TRI_THEO_BPCP
        rpt.Site = Me.Site
        Return rpt
    End Function
