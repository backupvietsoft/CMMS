...
Public Class rptSubTGBH_CANG_CONTAINER
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubTGBH_CANG_CONTAINER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubTGBH_CANG_CONTAINER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubTGBH_CANG_CONTAINER = New rptSubTGBH_CANG_CONTAINER
        rpt.Site = Me.Site
        Return rpt
    End Function
