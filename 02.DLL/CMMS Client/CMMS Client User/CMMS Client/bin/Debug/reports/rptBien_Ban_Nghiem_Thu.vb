...
Public Class rptBien_Ban_Nghiem_Thu
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBien_Ban_Nghiem_Thu.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBien_Ban_Nghiem_Thu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBien_Ban_Nghiem_Thu = New rptBien_Ban_Nghiem_Thu
        rpt.Site = Me.Site
        Return rpt
    End Function
