...
Public Class rptDanhSachPhieuNhap
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDanhSachPhieuNhap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDanhSachPhieuNhap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDanhSachPhieuNhap = New rptDanhSachPhieuNhap
        rpt.Site = Me.Site
        Return rpt
    End Function
