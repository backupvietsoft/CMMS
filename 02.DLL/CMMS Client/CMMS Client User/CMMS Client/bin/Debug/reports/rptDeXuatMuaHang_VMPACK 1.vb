...
Public Class rptDeXuatMuaHang_VMPACK_1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDeXuatMuaHang_VMPACK 1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeXuatMuaHang_VMPACK_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeXuatMuaHang_VMPACK_1 = New rptDeXuatMuaHang_VMPACK_1
        rpt.Site = Me.Site
        Return rpt
    End Function
