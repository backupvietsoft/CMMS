...
Public Class rptCOMPARE_SO_LUONG_XUAT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCOMPARE_SO_LUONG_XUAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCOMPARE_SO_LUONG_XUAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCOMPARE_SO_LUONG_XUAT = New rptCOMPARE_SO_LUONG_XUAT
        rpt.Site = Me.Site
        Return rpt
    End Function
