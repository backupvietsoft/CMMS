...
Public Class rptDeXuatMuaHang_DUYTAN
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDeXuatMuaHang_DUYTAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeXuatMuaHang_DUYTAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeXuatMuaHang_DUYTAN = New rptDeXuatMuaHang_DUYTAN
        rpt.Site = Me.Site
        Return rpt
    End Function
