...
Public Class rptCONG_VIEC_HANG_NGAY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCONG_VIEC_HANG_NGAY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCONG_VIEC_HANG_NGAY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCONG_VIEC_HANG_NGAY = New rptCONG_VIEC_HANG_NGAY
        rpt.Site = Me.Site
        Return rpt
    End Function
