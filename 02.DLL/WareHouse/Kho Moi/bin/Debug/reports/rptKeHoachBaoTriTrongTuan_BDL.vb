...
Public Class rptKeHoachBaoTriTrongTuan_BDL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptKeHoachBaoTriTrongTuan_BDL.rpt"
        End Get
...
Public Class CachedrptKeHoachBaoTriTrongTuan_BDL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKeHoachBaoTriTrongTuan_BDL = New rptKeHoachBaoTriTrongTuan_BDL
        rpt.Site = Me.Site
        Return rpt
    End Function
