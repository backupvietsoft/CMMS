...
{
    public partial class ucBaoCaoChiPhiChiTiet : DevExpress.XtraEditors.XtraUserControl
    {
        public ucBaoCaoChiPhiChiTiet()
        {
            InitializeComponent();
        }
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetBaoCaoChiPhiChiTiet", datTNgay.DateTime, datDNgay.DateTime,
                 sDChuyen, iHThong, iBPhan, sLmay, Commons.Modules.UserName, sMsMay));
            if (dtTmp.Rows.Count == 0)
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucBaoCaoChiPhiChiTiet",
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucBaoCaoChiPhiChiTiet", "TenMay", Commons.Modules.TypeLanguage) + " : " + cboThietBi.GetColumnValue("TEN_MAY").ToString();
