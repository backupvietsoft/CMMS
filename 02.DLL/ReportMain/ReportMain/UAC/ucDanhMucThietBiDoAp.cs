...
{
    public partial class ucDanhMucThietBiDoAp : DevExpress.XtraEditors.XtraUserControl
    {
        public ucDanhMucThietBiDoAp()
        {
            InitializeComponent();
        }
        ...
        private void ucDanhMucThietBiDoAp_Load(object sender, EventArgs e)
        {
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            if (datTNgay.Text == "")
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucDanhMucThietBiDoAp", "KhongCoNam", Commons.Modules.TypeLanguage));
                cboDDiem.Focus();
                return;
            }
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucDanhMucThietBiDoAp", "KhongCoDDiem", Commons.Modules.TypeLanguage));
                cboDDiem.Focus();
                return;
            }
            ...
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucDanhMucThietBiDoAp", "KhongCoDChuyen", Commons.Modules.TypeLanguage));
                cboDChuyen.Focus();
                return;
            }
            if (cboLMay.Text == "")
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucDanhMucThietBiDoAp", "KhongCoLMay", Commons.Modules.TypeLanguage));
                cboDChuyen.Focus();
                return;
            }
            ...
            try
            {
                ...
                DataTable dtTmp = new DataTable();
                dtTmp.Load(SqlHelper.ExecuteReader(Commons.IConnections.ConnectionString, "GetDMTBDoAp",
                        TNgay, DNgay, Commons.Modules.UserName, cboDDiem.EditValue, cboDChuyen.EditValue, cboLMay.EditValue));

                if (dtTmp.Rows.Count == 0)
                {
                    XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName, "ucDanhMucThietBiDoAp",
                ...
                grvChung.Columns["STT"].Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "STT", Commons.Modules.TypeLanguage);
                grvChung.Columns["TEN_PT"].Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "TEN_PT", Commons.Modules.TypeLanguage);
                grvChung.Columns["MS_PT"].Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "MS_PT", Commons.Modules.TypeLanguage);
                grvChung.Columns["MS_VI_TRI"].Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "MS_VI_TRI", Commons.Modules.TypeLanguage);
                grvChung.Columns["NGAY_HC_CUOI"].Caption = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "NGAY_HC_CUOI", Commons.Modules.TypeLanguage);
            ...
            catch (Exception ex)
            {
                XtraMessageBox.Show(Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "InKhongThanhCong", Commons.Modules.TypeLanguage) + "\n" +
        ...
        private void InDuLieu()
        {
            ...
            try
            {
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "TieuDe", Commons.Modules.TypeLanguage), Dong, 4, "@", 16, true,
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "NgayHienTai", Commons.Modules.TypeLanguage) + " : " + System.DateTime.Now.Date.ToShortDateString();
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 10, "@", 10, true,
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "TongSoTrang", Commons.Modules.TypeLanguage) + " : " + " &P / &N";
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, Dong, 10, "@", 10, true,
                    Excel.XlHAlign.xlHAlignLeft, Excel.XlVAlign.xlVAlignCenter, true, Dong, 10);
                ...
                Dong = Dong + 2;
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "ChiNhanh", Commons.Modules.TypeLanguage) + " : " + cboDDiem.TextValue;
                ...
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, datTNgay.Text, Dong, 6, "@", 10, true,
                ...
                prbIN.Update();
                #endregion
                //= ActiveWorkbooks.Worksheets.Count
                ...
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 26, "@", true, Dong + 1, 2, TDong + Dong, 2);
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 15, "@", true, Dong + 1, 3, TDong + Dong, 3);
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 24, "@", true, Dong + 1, 4, TDong + Dong, 4);
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 12, oldCultureInfo.DateTimeFormat.ShortDatePattern, true, Dong + 1, 5, TDong + Dong, 5);
                Commons.Modules.MExcel.ColumnWidth(xlWorkSheet, 4, "@", true, Dong + 1, 6, TDong + Dong, TCot);
                
                title = Commons.Modules.MExcel.GetRange(xlWorkSheet, Dong + 1, 5, TDong + Dong, TCot);
                title.HorizontalAlignment = Excel.XlHAlign.xlHAlignCenter;
                title.VerticalAlignment = Excel.XlVAlign.xlVAlignCenter;
                ...
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                        "ucDanhMucThietBiDoAp", "TongSoTrang", Commons.Modules.TypeLanguage) + " : " + n.ToString();
                Commons.Modules.MExcel.DinhDang(xlWorkSheet, stmp, 6, 10, "@", 10, true,
                    Excel.XlHAlign.xlHAlignLeft, Excel.XlVAlign.xlVAlignCenter, true, 6, 10);


                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                   "ucDanhMucThietBiDoAp", "DuoiTrai", Commons.Modules.TypeLanguage);
                xlWorkSheet.PageSetup.LeftFooter = stmp;
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "Trang", Commons.Modules.TypeLanguage);
                xlWorkSheet.PageSetup.CenterFooter = stmp + " &P / &N";
                //00/30.06.2013
                stmp = Commons.Modules.ObjLanguages.GetLanguage(Commons.Modules.ModuleName,
                    "ucDanhMucThietBiDoAp", "DuoiPhai", Commons.Modules.TypeLanguage);
