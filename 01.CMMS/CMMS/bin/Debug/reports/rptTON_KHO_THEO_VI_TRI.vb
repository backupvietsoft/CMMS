...
Public Class rptTON_KHO_THEO_VI_TRI
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTON_KHO_THEO_VI_TRI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTON_KHO_THEO_VI_TRI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTON_KHO_THEO_VI_TRI = New rptTON_KHO_THEO_VI_TRI
        rpt.Site = Me.Site
        Return rpt
    End Function
