...
Public Class rptDanhSachNhanVien
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDanhSachNhanVien.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDanhSachNhanVien
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDanhSachNhanVien = New rptDanhSachNhanVien
        rpt.Site = Me.Site
        Return rpt
    End Function
