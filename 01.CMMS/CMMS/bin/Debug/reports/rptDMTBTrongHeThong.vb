...
Public Class rptDMTBTrongHeThong
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDMTBTrongHeThong.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDMTBTrongHeThong
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDMTBTrongHeThong = New rptDMTBTrongHeThong
        rpt.Site = Me.Site
        Return rpt
    End Function
