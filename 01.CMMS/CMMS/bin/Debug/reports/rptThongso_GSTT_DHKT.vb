...
Public Class rptThongso_GSTT_DHKT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptThongso_GSTT_DHKT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NGAY() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptThongso_GSTT_DHKT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptThongso_GSTT_DHKT = New rptThongso_GSTT_DHKT
        rpt.Site = Me.Site
        Return rpt
    End Function
