...
Public Class rptSubKetLuan_CANG_CONTAINER
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubKetLuan_CANG_CONTAINER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubKetLuan_CANG_CONTAINER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubKetLuan_CANG_CONTAINER = New rptSubKetLuan_CANG_CONTAINER
        rpt.Site = Me.Site
        Return rpt
    End Function
