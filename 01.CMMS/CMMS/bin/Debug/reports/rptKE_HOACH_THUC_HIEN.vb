...
Public Class rptKE_HOACH_THUC_HIEN
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptKE_HOACH_THUC_HIEN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKE_HOACH_THUC_HIEN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKE_HOACH_THUC_HIEN = New rptKE_HOACH_THUC_HIEN
        rpt.Site = Me.Site
        Return rpt
    End Function
