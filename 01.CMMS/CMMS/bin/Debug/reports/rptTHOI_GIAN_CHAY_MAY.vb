...
Public Class rptTHOI_GIAN_CHAY_MAY
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptTHOI_GIAN_CHAY_MAY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTHOI_GIAN_CHAY_MAY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTHOI_GIAN_CHAY_MAY = New rptTHOI_GIAN_CHAY_MAY
        rpt.Site = Me.Site
        Return rpt
    End Function
