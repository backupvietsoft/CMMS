...
DECLARE @menuText NVARCHAR(500) = N'9.1. Yêu cầu hỗ trợ'
DECLARE @menuTextA NVARCHAR(500) = N'9.1. Yêu cầu hỗ trợ'
DECLARE @MENU_PARENT NVARCHAR(500) = N'mnuHelp'
SET @menu1 = 'mnuYeuCauHoTro'
set @menu =  N'ΞΠήͶΎή͊Άή͔΢ͬΨ΢'
...
IF NOT EXISTS (SELECT * FROM dbo.MENU WHERE MENU_ID = @menu1)
	INSERT	dbo.MENU(MENU_ID,MENU_TEXT,MENU_ENGLISH,MENU_PARENT,MENU_LINE,MENU_INDEX,CLASS_NAME,FUNCTION_NAME,AN_HIEN)
		VALUES(@menu1, @menuText,  @menuTextA, @MENU_PARENT,0,1,'frmMain','ShowYeuCauHoTro',1 )
